...
//            return false; 这些东西遇到了再改，最后过代码的时候删除残留
    ...
    public void init(Context context) {
        ...
        startButton = findView(R.id.start);
        fullscreenButton = findView(R.id.fullscreen);
        progressBar = findView(R.id.bottom_seek_progress);
        currentTimeTextView = findView(R.id.current);
        totalTimeTextView = findView(R.id.total);
        bottomContainer = findView(R.id.layout_bottom);
        textureViewContainer = findView(R.id.surface_container);
        topContainer = findView(R.id.layout_top);
