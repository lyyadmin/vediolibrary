...
public class JzvdStd extends Jzvd {
    ...
    public void init(Context context) {
        super.init(context);
        batteryTimeLayout = findView(R.id.battery_time_layout);
        bottomProgressBar = findView(R.id.bottom_progress);
        titleTextView = findView(R.id.title);
        backButton = findView(R.id.back);
        thumbImageView = findView(R.id.thumb);
        loadingProgressBar = findView(R.id.loading);
        tinyBackImageView = findView(R.id.back_tiny);
        batteryLevel = findView(R.id.battery_level);
        videoCurrentTime = findView(R.id.video_current_time);
        replayTextView = findView(R.id.replay_text);
        clarity = findView(R.id.clarity);
        mRetryBtn = findView(R.id.retry_btn);
        mRetryLayout = findView(R.id.retry_layout);
...
//        }
    ...
    public void showWifiDialog() {
        ...
        builder.setPositiveButton(getResources().getString(R.string.tips_not_wifi_confirm), new android.content.DialogInterface.OnClickListener() {
        ...
        builder.setNegativeButton(getResources().getString(R.string.tips_not_wifi_cancel),new android.content.DialogInterface.OnClickListener() {
